...
_aur_guard_runtime_extract_candidate() {
  ...
  python3 - "$source" "$candidate" <<'PY_RUNTIME_EXTRACT' || return 1
import sys
...
_aur_guard_runtime_activate_candidate() {
  ...
  if _aur_guard_runtime_cache_valid; then
    ...
    if ! cp -- "$_AUR_GUARD_RUNTIME_FILE" "$runtime_backup"         || ! cp -- "$_AUR_GUARD_RUNTIME_METADATA" "$metadata_backup"         || ! chmod 0600 -- "$runtime_backup" "$metadata_backup"; then
...
_aur_guard_verify_signed_metadata_chain() {
  local pkgbase="$1"
  local srcinfo="$2"
  local pkgdir="$3"
...
aurguardtest() (
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
    ...
    _aur_guard_runtime_dispatch aurguardtest "$@"
    return $?
  fi
...
aurinstalled() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch aurinstalled "$@"
    return $?
  fi
...
aurremove() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch aurremove "$@"
    return $?
  fi
...
auruninstall() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch auruninstall "$@"
    return $?
  fi
...
sysupdate() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch sysupdate "$@"
    return $?
  fi
...
aurcheck() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch aurcheck "$@"
    return $?
  fi
...
aurverify() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch aurverify "$@"
    return $?
  fi
...
aurinstall() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch aurinstall "$@"
    return $?
  fi
...
aurup() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch aurup "$@"
    return $?
  fi
...
aur() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch aur "$@"
    return $?
  fi
...
aurguard() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch aurguard "$@"
    return $?
  fi
...
aurunsafe() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch aurunsafe "$@"
    return $?
  fi
...
yay() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch yay "$@"
    return $?
  fi
...
paru() {
  ...
  if [[ ${AWTARCHY_AURGUARD_RUNTIME_ACTIVE:-0} != 1 \
      && ${AUR_GUARD_TEST_MODE:-0} != 1 ]]; then
    _aur_guard_runtime_dispatch paru "$@"
    return $?
  fi
