...
assert_not_contains "${REPO_ROOT}/config/hypr/scripts/quickshell.sh" 'kill -TERM -- "$pid"'
assert_not_contains "${REPO_ROOT}/config/hypr/scripts/quickshell.sh" 'kill -KILL -- "$pid"'
assert_contains "${REPO_ROOT}/config/hypr/scripts/quickshell.sh" 'os.pidfd_open(pid, 0)'
assert_contains "${REPO_ROOT}/config/hypr/scripts/quickshell.sh" 'signal.pidfd_send_signal(pidfd, signal.SIGTERM)'
assert_contains "${REPO_ROOT}/config/hypr/scripts/quickshell.sh" 'qs -c "$CONFIG_NAME" list --json'
assert_contains "${REPO_ROOT}/config/hypr/scripts/quickshell.sh" 'executable="${executable% (deleted)}"'
assert_contains "${REPO_ROOT}/config/hypr/scripts/quickshell.sh" 'process_identity_is_running'
assert_contains "${REPO_ROOT}/config/hypr/scripts/quickshell.sh" 'wait_for_pids_stop "${identities[@]}"'
assert_not_contains "${REPO_ROOT}/config/hypr/scripts/quickshell.sh" 'wait_for_shell_stop'
